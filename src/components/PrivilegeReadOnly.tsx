  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-row items-center space-x-3 space-y-0 rounded-md border p-4">
        <Checkbox
          checked={privilege.skipUserTokenExpiry}
          disabled
        />
        <div className="space-y-0.5">
          <Label>Skip User Token Expiry</Label>
          <p className="text-sm text-muted-foreground">
            This privilege {privilege.skipUserTokenExpiry ? 'will' : 'will not'} skip user token expiry.
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        <Table>
          ...
          <TableBody>
            ...
            {(!privilege.privilegeRules || privilege.privilegeRules.length === 0) && (
              <TableRow>
